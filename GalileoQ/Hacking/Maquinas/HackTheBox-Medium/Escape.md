...
Con este comando vamos a generar una solicitud de certificado para el usuario "ryan.cooper", con el objetivo de solicitar un certificado UPN "administrator", y utilizando la plantilla de certificado llamada "UserAuthentication". Todo esto se realiza dentro de un entorno de Active Directory, y la CA utilizada para firmar el certificado es "sequel-dc-ca".
```python
