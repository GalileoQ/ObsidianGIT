...
En nuestro escaneo de nmap logramos identificar dos puertos abiertos. puerto 22/ssh y puerto 80/http ademas tenemos un dominio que agregaremos a nuestro archivo host.
```python
