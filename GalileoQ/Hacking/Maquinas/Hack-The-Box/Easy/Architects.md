...
`scp`
encontramos un archivo Passwords.kdbx así que vamos a salir de la conexión ssh para poder copiar este archivo al host anterior ya que sera mas facil para luego enviarlo a nuestra maqui
