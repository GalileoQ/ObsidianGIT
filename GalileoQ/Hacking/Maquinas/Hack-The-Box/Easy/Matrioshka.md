...
haciendo uso de `netstat -atunp` podemos identificar dos puertos que estan corriendo en local `127.0.0.1:8080 - 127.0.0.1:9090` idealmente deberiamos realizar un `Port Forwarding` para ambos puer
