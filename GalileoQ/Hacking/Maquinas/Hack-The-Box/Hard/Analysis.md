...
haciendo uso de la herramienta `snort` podemos realizar una explotación de privilegios usando el [Dynamic Modules] el cual  [dynamicpreprocessor](http://manual-snort-org.s3-website-us-east-1.amazonaws.com/node23.html) 
