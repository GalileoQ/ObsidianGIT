...
# Este comando establece un túnel con Chisel desde la máquina cliente (Windows) hacia el servidor Chisel (M)en la dirección IP `10.10.14.207` y el puerto `1133`. Además, configura una redirección para el puerto `8083`, redirigiendo el tráfico del servidor al puerto `8083` en la misma máquina cliente.
```
