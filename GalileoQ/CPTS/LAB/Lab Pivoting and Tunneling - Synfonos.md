...
`aqui se me ocurre que si el usuario root esta haciendo una copia del /etc/shadow en esta dirección > /var/backups/shadow.bak y el servicio ftp es vulnerable a copias de archivos entonces nosotros podriamos traernos el archivo /var/backups ` 
